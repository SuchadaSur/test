...
// const test1 = document.querySelector(".dataTables_scrollHeadInner");
...
menu.addEventListener('click', function () {
  ...
  if(sidebar.classList.contains('shortly-sidebar')){
    ...
    //  setTimeout('div_register.style.width = "97%";',1);//97
    ...
    //  setTimeout('div_register.style.left ="60px";',175);
     ...
     }else if(window.innerWidth > 1365 && window.innerWidth < 2560){
      setTimeout('document.querySelector(".dataTables_scrollHeadInner").style.width ="100%";',1)
      setTimeout('document.querySelector(".table.table-hover.table-bordered.nowrap.no-footer.dataTable").style.width ="100%";',1)
      // setTimeout('div_register.style.width = "94.8%";',1);
      // setTimeout('div_register.style.position ="fixed";',175);
      // setTimeout('div_register.style.left ="60px";',175);
      setTimeout('div_register.style.zIndex = "0";',175);
    }else if(window.innerWidth > 1023 && window.innerWidth < 1365){
